...
with open(results_files_path + "/results.txt", 'w') as results_file:
    ...
    # print(text)
        if draw_plot:
            ...
            fig.canvas.set_window_title('AP ' + class_name)
            # set plot title
            plt.title('class: ' + text,fontsize=23)
            #plt.suptitle('This is a somewhat long figure title', fontsize=16)
            # set axis titles
            ...
            # F1
            # plt.plot(score, F1, "-", color='#BA55D3',linewidth = 3)
            #
            # plt.title('class: ' + F1_text + "\nscore_threhold=0.5",fontsize=25)
            # plt.grid(linestyle='-.', color='darkgray')
            # plt.xlabel('Score_Threhold',fontsize=25)
            ...
            # #Recall
            #
            # plt.plot(score, rec, "-", color='#DC143C',linewidth = 3)
            # plt.title('class: ' + Recall_text + "\nscore_threhold=0.5",fontsize=25)
            # plt.grid(linestyle='-.', color='darkgray')
            # plt.xlabel('Score_Threhold',fontsize=25)
            ...
            plt.plot(score, prec, "-", color='#48D1CC', linewidth=3)
            plt.title('class: ' + Precision_text + "\nscore_threhold=0.5", fontsize=25)
            plt.grid(linestyle='-.', color='darkgray')
            plt.xlabel('Score_Threhold')
            plt.ylabel('Precision')
